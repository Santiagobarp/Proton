...
categorias['comida'] = int(input("""
                            Escribe cuanto gastas en comida: """))

categorias['renta'] = int(input("""
                            Escribe cuanto gastas en renta: """))

categorias['carro'] = int(input("""
                            Escribe cuanto gastas en el carro: """))

categorias['otros'] = int(input("""
...
if gasto_mensual < ingreso_mensual*0.6 and deudas == "no":
    ...
    print("Tus finanzas son estables, pero podrías mejorar tu ahorro.")
